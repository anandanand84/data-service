...
func:b});return a};c.prototype.unsubscribe=function(d){for(var b in this.topics)if(this.topics[b]){for(var a=0,e=this.topics[b].length;a<e;a++)if(this.topics[b][a].token===d)return this.topics[b].splice(a,1),!0;0==this.topics[b].length&&delete this.topics[b]}return!1};c._instance=null;return c}(),isNode,dcodeIO=dcodeIO||{};"undefined"!==typeof exports&&this.exports!==exports&&(WebSocket=require("ws"),dcodeIO.ProtoBuf=require("protobufjs"),isNode=!0);
if(!(isNode||"undefined"!==typeof dcodeIO&&dcodeIO.ProtoBuf))throw Error("ProtoBuf.js is not present. Please see www/index.html for manual setup instructions.");
